...
const { areJidsSameUser, isHostedLidUser, isHostedPnUser, isJidBroadcast, isJidGroup, isJidMetaAI, isJidNewsletter, isJidStatusBroadcast, isLidUser, isPnUser } = require('../WABinary/index.js');
const { unpadRandomMax16 } = require('./generics.js');
...
exports.ACCOUNT_RESTRICTED_TEXT = ACCOUNT_RESTRICTED_TEXT;
